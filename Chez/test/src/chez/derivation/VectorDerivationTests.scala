...
object VectorDerivationTests extends TestSuite {
  ...
  val tests = Tests {
    test("Vector[T] derivation") {
      ...
      test("Vector[Double] generates array without uniqueItems") {
        val schema = Schema[Vector[Double]]
        val json = schema.toJsonSchema
      ...
      test("Vector[Float] generates array without uniqueItems") {
        val schema = Schema[Vector[Float]]
        val json = schema.toJsonSchema
    ...
    test("Vector vs Set vs List comparison") {
      test("Vector, Set, and List have different uniqueItems behavior") {
        val vectorSchema = Schema[Vector[String]]
        val setSchema = Schema[Set[String]]
        val listSchema = Schema[List[String]]
    ...
    test("Vector with complex value types") {
      ...
      test("Vector[List[T]] works correctly") {
        val schema = Schema[Vector[List[String]]]
        val json = schema.toJsonSchema
      ...
      test("Vector[Set[T]] works correctly") {
        val schema = Schema[Vector[Set[String]]]
        val json = schema.toJsonSchema
      ...
      test("Vector[Map[String, T]] works correctly") {
        val schema = Schema[Vector[Map[String, Int]]]
        val json = schema.toJsonSchema
    ...
    test("Vector derivation edge cases") {
      test("Vector[Option[T]] works correctly") {
        val schema = Schema[Vector[Option[String]]]
        val json = schema.toJsonSchema
      ...
      test("Empty Vector types compile correctly") {
        ...
        val stringVectorSchema = Schema[Vector[String]]
        val intVectorSchema = Schema[Vector[Int]]
        val boolVectorSchema = Schema[Vector[Boolean]]
        val doubleVectorSchema = Schema[Vector[Double]]
        val longVectorSchema = Schema[Vector[Long]]
        val floatVectorSchema = Schema[Vector[Float]]
