...
import boogieloops.validation.{ValidationResult, ValidationContext}
...
case class IdSchema[T <: Schema](
  ...
  override def optional: Schema = boogieloops.modifiers.OptionalSchema(this)
  override def nullable: Schema = boogieloops.modifiers.NullableSchema(this)
  override def withDefault(value: ujson.Value): Schema = boogieloops.modifiers.DefaultSchema(this, value)
  ...
  override def withSchema(schema: String): Schema = SchemaSchema(this, schema)
  override def withDefs(defs: (String, Schema)*): Schema = boogieloops.modifiers.DefsSchema(Some(this), defs.toMap)
}
