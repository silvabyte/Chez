...
case class ExamplesSchema[T <: Schema](
  ...
  override def optional: Schema = boogieloops.OptionalSchema(this)
  override def nullable: Schema = boogieloops.NullableSchema(this)
  override def withDefault(value: ujson.Value): Schema = boogieloops.DefaultSchema(this, value)
