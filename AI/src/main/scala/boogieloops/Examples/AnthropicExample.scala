...
import boogieloops.ai.providers.AnthropicProvider
...
object AnthropicExample extends App with Logging:
  ...
  def exampleStructuredOutput(): Unit = {
    ...
    case class CodeReview(
        @Schematic.description("Overall code quality score (1-10)") score: Int,
        @Schematic.description("Summary of the code") summary: String,
        @Schematic.description("List of strengths") strengths: List[String],
        @Schematic.description("List of areas for improvement") improvements: List[String],
        @Schematic.description("Security concerns if any") securityConcerns: List[String],
        @Schematic.description("Specific actionable recommendations") recommendations: List[String]
  ...
  def exampleComplexStructuredOutput(): Unit = {
    ...
    case class TechnicalAnalysis(
        @Schematic.description("Technology name") technology: String,
        @Schematic.description("Brief description") description: String,
        @Schematic.description("Key advantages") advantages: List[String],
        @Schematic.description("Key disadvantages") disadvantages: List[String],
        @Schematic.description("Use cases") useCases: List[UseCase],
        @Schematic.description("Comparison with alternatives") alternatives: List[Alternative],
        @Schematic.description("Future outlook") futureOutlook: String,
        @Schematic.description("Recommended for") recommendedFor: List[String]
    ) derives Schematic, ReadWriter

    case class UseCase(
        @Schematic.description("Use case name") name: String,
        @Schematic.description("Description") description: String,
        @Schematic.description("Why it's suitable") rationale: String
    ) derives Schematic, ReadWriter

    case class Alternative(
        @Schematic.description("Alternative technology") name: String,
        @Schematic.description("When to prefer this alternative") whenToUse: String
    ) derives Schematic, ReadWriter
