...
// Example 2: Structured data (builds on basic text)
  def structured(): Unit = {
    ...
    case class Task(
        @Schematic.description("Task description") task: String,
        @Schematic.description("Priority level") priority: String,
        @Schematic.description("Time in minutes") @Schematic.minimum(1) minutes: Int
