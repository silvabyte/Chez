...
import utest.*
import chezwiz.agent.{Agent, ChatRequest, ChatResponse, ChezError, Embedding, EmbeddingInput, EmbeddingRequest, EmbeddingResponse, ObjectRequest, ObjectResponse, PreEmbeddingContext, PostEmbeddingContext, RequestMetadata, Usage}
  ...
  val tests = Tests {
    ...
    test("Agent validates provider embedding support") {
      ...
      val mockProvider = new chezwiz.agent.providers.LLMProvider {
        ...
        def generateObject(request: ObjectRequest) = Left(ChezError.ConfigurationError("Not implemented"))
        ...
        protected def parseResponse(responseBody: String) = Left(ChezError.ConfigurationError("Not implemented"))
        protected def parseObjectResponse(responseBody: String) = Left(ChezError.ConfigurationError("Not implemented"))
      }
