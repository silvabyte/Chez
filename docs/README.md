...
```scala
mvn"dev.boogieloop::schema:0.5.6"  // Core schemas
mvn"dev.boogieloop::web:0.5.6"     // HTTP validation + OpenAPI
mvn"dev.boogieloop::ai:0.5.6"      // LLM agents
mvn"dev.boogieloop::kit:0.5.6"     // General utilities
```
