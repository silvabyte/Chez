package boogieloops.schema.references
 ...
 */
//TODO: consolidate with modifiers.DefsSchema
case class RefSchema(
    ref: String
) extends Schema {
  ...
  override def validate(value: ujson.Value, context: ValidationContext): ValidationResult = {
    ...
    ValidationResult.invalid(List(boogieloops.schema.ValidationError.ReferenceError(ref, context.path)))
  }
