...
import boogieloops.schema.derivation.*
...
object EnumExample {
  ...
  case class Theme(name: String, primaryColor: Color, secondaryColor: Color) derives Schematic
  ...
  def main(args: Array[String]): Unit = {
    ...
    Try {
      val statusSchema = Schematic[Status]
    ...
    Try {
      val prioritySchema = Schematic[Priority]
    ...
    Try {
      val colorSchema = Schematic[Color]
    ...
    Try {
      val themeSchema = Schematic[Theme]
