...
object ZeroToAppApi extends cask.MainRoutes {
  ...
  @Web.post(
    ...
    RouteSchema(
      ...
      body = Some(Schematic[CreateUser]),
      responses = Map(201 -> ApiResponse("Created", Schematic[User]))
    )
  )
  ...
  @Web.get(
    ...
    RouteSchema(
      ...
      responses = Map(200 -> ApiResponse("OK", Schematic[List[User]]))
    )
  )
  ...
  @Web.post(
    ...
    RouteSchema(
      ...
      body = Some(Schematic[ProfileSummary]),
      responses = Map(200 -> ApiResponse("OK", Schematic[UserInterests]))
    )
  )
